...
import com.ben.emberr.domain.selfhost.sync.ApiConfigSyncEntry
import com.ben.emberr.domain.selfhost.translation.EmbeddedBlockPayload
import com.ben.emberr.domain.util.ChatSyncEventBus
...
class SyncRepositoryImpl(
    ...
    override suspend fun applyRemoteChanges(changes: List<SyncEnvelope>): Boolean =
        withContext(Dispatchers.IO) {
            ...
            com.ben.emberr.domain.media.LocalMediaGcTrigger.requestCleanup()

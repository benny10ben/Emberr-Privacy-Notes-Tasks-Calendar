...
import com.ben.emberr.domain.selfhost.media.MediaReferenceScanner
import com.ben.emberr.domain.selfhost.merge.NoteMergeHelper
import com.ben.emberr.domain.selfhost.translation.EmbeddedBlockPayload
import com.ben.emberr.domain.selfhost.translation.NoteJsonCompiler
import com.ben.emberr.domain.selfhost.translation.NoteJsonParser
import com.ben.emberr.domain.selfhost.webdav.WebDavConfigurationException
import com.ben.emberr.domain.selfhost.webdav.WebDavConflictException
import com.ben.emberr.domain.selfhost.webdav.WebDavSyncClient
import com.ben.emberr.domain.selfhost.webdav.WebDavSyncPaths
import com.ben.emberr.domain.sync.MediaTransferPhase
import com.ben.emberr.domain.sync.MediaTransferStatusBus
import com.ben.emberr.domain.util.MediaStorageHelper
import com.ben.emberr.domain.util.withSyncCoordinatorOrSkip
...
class SelfHostSyncEngine(
    ...
    private suspend fun reconcileChatSession(
        ...
        com.ben.emberr.domain.util.ChatSyncEventBus.emitSessionChanged(sessionId)
        return remoteEntry
    }
    ...
    private suspend fun reconcileNote(candidateId: String, remoteEntry: SelfHostManifestEntry?): ReconcileOutcome {
        ...
        return try {
            ...
            com.ben.emberr.domain.util.SyncEventBus.emitSyncCompleted(

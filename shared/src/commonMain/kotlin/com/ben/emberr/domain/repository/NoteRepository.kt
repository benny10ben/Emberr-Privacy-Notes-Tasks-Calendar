...
interface NoteRepository {
    ...
    suspend fun getNoteTombstonesModifiedSince(timestamp: Long): List<com.ben.emberr.data.local.room.SelfHostDeletedNoteEntity>
    suspend fun getNoteTombstone(entityId: String): com.ben.emberr.data.local.room.SelfHostDeletedNoteEntity?

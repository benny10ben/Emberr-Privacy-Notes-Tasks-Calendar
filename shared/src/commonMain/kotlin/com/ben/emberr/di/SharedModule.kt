...
val sharedModule = module {
    ...
    viewModel {
        com.ben.emberr.presentation.mobile.home.HomeViewModel(
            repository = get(),
            settingsManager = get(),
            reminderScheduler = get(),
            taskExtractor = get(),
    ...
    viewModel {
        com.ben.emberr.presentation.mobile.home.overview.tasks.TasksViewModel(
            repository = get(),
            reminderScheduler = get()
        )
    }
    viewModel {
        com.ben.emberr.presentation.mobile.home.overview.images.ImagesViewModel(
            repository = get(),
            mediaStorageHelper = get()
        )
    }
    viewModel {
        com.ben.emberr.presentation.mobile.home.overview.documents.DocumentsViewModel(
            repository = get(),
            mediaStorageHelper = get()
        )
    }
    viewModel {
        com.ben.emberr.presentation.mobile.home.overview.bookmarks.BookmarksViewModel(
            repository = get()
        )
    }
    viewModel {
    ...
    viewModel {
        com.ben.emberr.presentation.mobile.home.note.NoteEditorViewModel(
            repository = get(),
            mediaStorageHelper = get(),
            reminderScheduler = get(),
            audioRecorder = get(),
    ...
    viewModel {
        com.ben.emberr.presentation.calendar.CalendarViewModel(
            repository = get(),
            reminderScheduler = get(),
            settingsManager = get()
        )

...
import com.ben.emberr.presentation.shared.editor.BaseEditorViewModel
...
class NoteEditorViewModel(
    ...
    init {
        viewModelScope.launch {
            com.ben.emberr.domain.util.SyncEventBus.events.collect { event ->
                if (event !is com.ben.emberr.domain.util.NoteSyncEvent.NoteChanged) return@collect
    ...
    fun loadNote(noteId: String) {
        ...
        com.ben.emberr.domain.util.AiEventBus.activeNoteId = noteId
    ...
    fun generatePlainTextExport(): String {
        ...
        val body = com.ben.emberr.domain.util.ExportEngine.generatePlainText(_blocks.value)
        return "$title\n\n$body"
    }

    fun generateMarkdownExport(): String {
        val title = _noteTitle.value.ifBlank { "Untitled Note" }
        val body = com.ben.emberr.domain.util.ExportEngine.generateMarkdown(_blocks.value)
        return "# $title\n\n$body"
    }
}

...
class WebDavSyncPathsTest {
    ...
    fun everyRemotePathSitsUnderTheSingleSyncRoot() {
        val allPaths = listOf(
            ...
            WebDavSyncPaths.dailyPath("2026-01-01"),
    ...
    fun eachKindOfRecordGetsItsOwnPrefixedEncryptedFile() {
        ...
        assertEquals("/emberr_sync/daily/daily_2026-01-01.enc", WebDavSyncPaths.dailyPath("2026-01-01"))
    ...
    fun twoDifferentRecordsNeverShareAPath() {
        val paths = setOf(
            ...
            WebDavSyncPaths.dailyPath("same-id"),

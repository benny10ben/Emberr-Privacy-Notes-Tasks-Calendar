...
object WebDavServerUrlValidator {
    ...
    private fun expandIpv6Groups(host: String): List<Int>? {
        ...
        // "::" can only appear once in a valid address - it marks where the run of zero
        // groups was compressed, and a second occurrence would make that expansion ambiguous.
